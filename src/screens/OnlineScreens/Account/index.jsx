    ...
    <div className='flex flex-col items-center justify-center mt-20'>
        ...
        <div className='flex flex-col items-center justify-center'> 
            <div className='relative w-40 h-40 flex flex-col'>
                ...
                <Link to={`/edit-avatar`} className='absolute bottom-0 right-0 border rounded-full p-2 cursor-pointer hover:text-green_top'>
        ...
        <div className='relative w-80 h-auto border rounded-lg flex flex-col items-center my-5 pb-10'>
            ...
            <Link to="/edit-info" className='absolute bottom-3 right-2 border rounded-full p-2 cursor-pointer hover:text-green_top'>
                <BsFillPencilFill size={20} />
            </Link>
        </div>
    </div>
